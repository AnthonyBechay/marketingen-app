...
//
// Values are ported VERBATIM from the Python CLI tool's brand.json and
// campaign.json — including the en-dash characters in things like
// "5–10 days" and "6–10 hashtags".
...
export const BECHAI_CAMPAIGN = {
  ...
  pillars: [
    {
      name: "Value",
      description: "What we build, transparent pricing, what's included.",
    },
    {
      name: "Proof",
      description: "Case studies of real shipped products. Show the work.",
    },
    {
      name: "Comparison",
      description:
        "Why studio > agency, why custom > template, why owning code > SaaS subscription.",
    },
    {
      name: "Education",
      description:
        "Teach SMB owners and founders what's possible with modern tools and AI.",
    },
    {
      name: "Behind the scenes",
      description:
        "Build-in-public, technical depth, infrastructure, how I ship fast.",
    },
  ],
  toneRules: [
...
// 20 ideas, ranked roughly in posting order. The first 7 are the original
// CLI launch lineup (post1-website-reveal → post-7-hetzner-vs-aws); the
// remaining 13 are the queue + planned future posts.
export const BECHAI_QUEUE: Array<{
...
}> = [
  {
    ...
    format: "story",
    notes:
      "Single-image launch announcement with $1K / 5–10 day / 10+ products stats.",
  },
  {
  ...
  },
  {
    ...
    format: "carousel",
    notes:
      "Booking system, client portal, invoice/inventory, AI chatbot, business dashboard. Each with 4 features.",
  },
  {
    ...
    format: "carousel",
    notes:
      "$15K vs $1K, 3-6mo vs 5–10 days, 20-person team vs one senior dev.",
  },
  {
    ...
    format: "carousel",
    notes:
      "Problem statement, feature grid, results. AI search via Anthropic Claude.",
  },
  {
    ...
    format: "carousel",
    notes:
      "For SMBs running on WhatsApp + Excel. List 5 automation signals with case study close.",
  },
  {
    topic:
      "Hetzner vs AWS for small businesses — why I run all client apps on Hetzner",
    pillar: "Behind the scenes",
    format: "carousel",
    notes:
      "Highlight cost savings, dedicated resources, no surprise bills. Mention the live infrastructure dashboard at /infrastructure.",
  },
  {
    ...
    format: "carousel",
    notes:
      "Address the trust/transparency angle. Compare to typical agency retainer model.",
  },
  {
    topic:
      "Luminworth case study — building a personal finance platform with mobile + web",
    pillar: "Proof",
    format: "carousel",
  ...
  {
    topic:
      "What $1,000 actually gets you — full breakdown of a Rapid Build deliverable",
    pillar: "Value",
    format: "carousel",
    notes:
      "Counter the 'too cheap to be real' objection. List exactly what's included.",
  },
  {
    ...
    format: "story",
    notes:
      "Terminal-style single-image. Show the actual deploy command + monitoring dashboard URL.",
  },
  {
  ...
  {
    topic:
      "Murex experience — what 8 years on trading systems taught me about shipping",
    pillar: "Behind the scenes",
    format: "carousel",
    notes:
      "Reporting, market data, integrations and interfaces. Position fintech expertise.",
  },
  {
    topic:
      "AI chatbot for your website — Arabic + English, trained on YOUR business",
    pillar: "Value",
    format: "carousel",
  ...
  },
  {
    ...
    format: "carousel",
    notes:
      "Honest take on AI tooling. Position as why I can charge fairly without cutting corners.",
  },
  {
  ...
  {
    topic:
      "Free 30-min call — what to expect (no pitch deck, just a conversation)",
    pillar: "Value",
    format: "carousel",
